...
my @want = (
  ...
  emptytagdef STRING DEFAULT '', -- Hello emptytagdef
...
SET DELIMITER ;],
    ...
    q[SET DELIMITER @
CREATE TRIGGER bar_trigger_insert FOR Basic BEFORE INSERT AS
 timest='NOW';
END_TRIGGER@
SET DELIMITER ;],
    ...
    q[SET DELIMITER @
CREATE TRIGGER bar_trigger_update FOR Basic BEFORE UPDATE AS
 timest='NOW';
END_TRIGGER@
SET DELIMITER ;]
);
